...
namespace QL_TourDuLich.GUI
{
    public partial class Form_ThemKhach : Form
    {
        ...
        private void btnChon_Click(object sender, EventArgs e)
        {
            ...
            Form_QL_ChiTietDoan.instance.chonKH(maKhachHang);
            this.Close();
        }
        ...
        private void load()
        {
            ...
            int c;
            foreach(KhachHang i in Form_QL_ChiTietDoan.instance.bus.lstKhachHang)
            {
                c = 0;
                foreach(KhachHang j in Form_QL_ChiTietDoan.instance.bus.KhachHangs)
                {
